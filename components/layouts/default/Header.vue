        ...
        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
          ...
          <div class="relative ml-6 md:mr-0 hidden md:block shrink w-full">
            ...
            <input type="text" id="email-adress-icon"
              class="bg-slate-900 text-gray-100 sm:text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2 dropdown-toggle whitespace-nowrap"
              placeholder="Search..." />
            <ul
              :class="dropdown_status ? 'dropdown-menu min-w-max absolute bg-gray-900 text-base z-50 py-2 list-none rounded-md w-full shadow-lg mt-1 m-0 bg-clip-padding border-none' : 'dropdown-menu hidden min-w-max absolute bg-white text-base z-50 float-left py-2 list-none text-left rounded-lg shadow-lg mt-1 m-0 bg-clip-padding border-none'"
              aria-labelledby="dropdownMenuButton1">
              <li v-for="category in categories" :key="category.id">
                <a class="dropdown-item text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-gray-100 hover:bg-gray-100"
                  ...
                  <div class="dropdown relative">
                    <button
                      ...
                      <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="caret-down"
                        class="w-2 mr-2" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
